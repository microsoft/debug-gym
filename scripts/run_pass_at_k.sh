...
for i in $(seq 1 $K); do
    ...
    python scripts/run.py scripts/config_swesmith.yaml --agent debug_agent -p base.llm_name="gpt-4o" -p base.output_path="exps/gpt-4o/test_4o_always_fail/" -p base.uuid="explanation_4o_$i" -n 5
