...
class Terminal:
    ...
    def run(
        ...
        self.logger.debug(f"Output from terminal with status {process.returncode}: {output}")
...
def select_terminal(terminal_config: dict | None = None, logger=logging.getLogger("froggy")) -> Terminal:
