...
from froggy.agents.zero_shot import AgentZeroShot, AgentZeroShot_NoPDB, AgentZeroShot_PdbAfterRewrites
...
class TestAgentZeroShot(unittest.TestCase):
    ...
    def test_build_question_prompt(self):
        ...
        self.assertIn("continue your debugging process using pdb commands or to propose a patch using rewrite command.", messages[0]["content"])

    def test_build_prompt(self):
        info = {"instructions": "Test instructions", "dir_tree": "Test dir tree", "editable_files": "Test editable files", "current_code_with_line_number": "Test code", "current_breakpoints": "Test breakpoints", "last_run_obs": "Test last run obs"}
